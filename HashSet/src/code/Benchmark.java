        ...
        switch(input) {
            case 1:
                try {
                    ...
                    for (int i = 0; i < numOfBooks; i++) {
                        ...
                        BookInterface.library.add(audioBook);
                        ...
                        BookInterface.library.add(printedBook);
                        endTime = System.nanoTime();
                        totalTime += (endTime - startTime);
                    }
            ...
            case 2:
                ...
                for (int i = 0; i < numberOfBooks; i++) {
                    // get the iterator over the HashSet
                    Iterator<Book> iterator = BookInterface.library.iterator();

                    // if there is a book, delete it
                    if(iterator.hasNext()) {
                        Book bookToDelete = iterator.next();
                        iterator.remove();
                    }
                }
