            ...
            case 1:
                try {
                    ...
                    for (int i = 0; i < numOfBooks; i++) {
                        ...
                        BookInterface.library.floor(audioBook);
                        ...
                        BookInterface.library.floor(printedBook);
                        endTime = System.nanoTime();
                        totalTime += (endTime - startTime);
                    }
            ...
            case 2:
                ...
                for (int i = 0; i < numberOfBooks; i++) {
                    if (!BookInterface.library.isEmpty()) {
                        String bookTitleToDelete = BookInterface.library.first().getTitle(); // get the title of the first book in the library
